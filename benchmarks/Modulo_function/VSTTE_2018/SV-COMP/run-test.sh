...
function test_cbmc {
  ...
  #stupid way to do it, but it works. If needed add more params
  echo ">> Run test case: $cbmc $1 --unwind 10"
  $cbmc $1 --unwind 10 >> ${HIFROG_OUTPUT} 2>&1
  if [[ $? -gt 0 ]]; then
...
hifrog=./../hifrog/trunk/cprover/src/funfrog/hifrog
cbmc=./../hifrog/trunk/cprover/src/cbmc/cbmc
